...
const transferOptionsVisibility: TransferOptionsVisibilityMap = {
  ...
  "Xpress-TibanIndah": ["TRANSFER_NAGOYA", "TRANSFER_BENGKONG", "TRANSFER_SERAYA", "TRANSFER_KDABATAMCENTRE"],
  "Xpress-KDABatamCentre": ["TRANSFER_NAGOYA", "TRANSFER_BENGKONG", "TRANSFER_SERAYA", "TRANSFER_TIBANINDAH"],
