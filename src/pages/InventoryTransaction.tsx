...
const transferOptionsVisibility: TransferOptionsVisibilityMap = {
  ...
  "Xpress-Paniki": ["TRANSFER_ITC", "TRANSFER_KLEAK", "TRANSFER_MALALAYANG", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL", "TRANSFER_TATELI"],
  "Xpress-ITC": ["TRANSFER_PANIKI", "TRANSFER_KLEAK", "TRANSFER_MALALAYANG", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL", "TRANSFER_TATELI"],
  "Xpress-Maumbi": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL", "TRANSFER_TATELI"],
  "Xpress-Tuminting": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL", "TRANSFER_TATELI"],
  "Xpress-17Agustus": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_PERKAMIL", "TRANSFER_TATELI"],
  "Xpress-Perkamil": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_TATELI"],
  "Xpress-Tateli": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL"],
};
