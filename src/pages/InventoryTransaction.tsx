...
const transferOptionsVisibility: TransferOptionsVisibilityMap = {
  ...
  "Podomoro-Malalayang": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL"],
  "Podomoro-Kleak": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL"],
  "Podomoro-Mantos": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL"],
  "Xpress-Paniki": ["TRANSFER_ITC", "TRANSFER_KLEAK", "TRANSFER_MALALAYANG", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL"],
  "Xpress-ITC": ["TRANSFER_PANIKI", "TRANSFER_KLEAK", "TRANSFER_MALALAYANG", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL"],
  "Podomoro-Maumbi": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL"],
  "Podomoro-Tuminting": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL"],
  "Podomoro-17Agustus": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_PERKAMIL"],
  "Podomoro-Perkamil": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS"],
