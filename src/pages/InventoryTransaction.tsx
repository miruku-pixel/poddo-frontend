...
const transferOptionsVisibility: TransferOptionsVisibilityMap = {
  ...
  "Xpress-Maumbi": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL"],
  "Xpress-Tuminting": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL"],
  "Xpress-17Agustus": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_PERKAMIL"],
  "Xpress-Perkamil": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS"],
