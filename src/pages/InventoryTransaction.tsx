...
const transferOptionsVisibility: TransferOptionsVisibilityMap = {
  "PoDDo-Nagoya": ["TRANSFER_BENGKONG", "TRANSFER_SERAYA", "TRANSFER_TIBANINDAH", "TRANSFER_KDABATAMCENTRE", "TRANSFER_MITRARAYA"],
  "PoDDo-Bengkong": ["TRANSFER_NAGOYA", "TRANSFER_SERAYA", "TRANSFER_TIBANINDAH", "TRANSFER_KDABATAMCENTRE", "TRANSFER_MITRARAYA"],
  "PoDDo-Seraya": ["TRANSFER_NAGOYA", "TRANSFER_BENGKONG", "TRANSFER_TIBANINDAH", "TRANSFER_KDABATAMCENTRE", "TRANSFER_MITRARAYA"],
  "Xpress-TibanIndah": ["TRANSFER_NAGOYA", "TRANSFER_BENGKONG", "TRANSFER_SERAYA", "TRANSFER_KDABATAMCENTRE", "TRANSFER_MITRARAYA"],
  "Xpress-KDABatamCentre": ["TRANSFER_NAGOYA", "TRANSFER_BENGKONG", "TRANSFER_SERAYA", "TRANSFER_TIBANINDAH", "TRANSFER_MITRARAYA"],
  "Xpress-MitraRaya": ["TRANSFER_NAGOYA", "TRANSFER_BENGKONG", "TRANSFER_SERAYA", "TRANSFER_TIBANINDAH", "TRANSFER_KDABATAMCENTRE"],
  "Podomoro-Malalayang": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL", "TRANSFER_TATELI", "TRANSFER_AIRMADIDI"],
  "Podomoro-Kleak": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL", "TRANSFER_TATELI", "TRANSFER_AIRMADIDI"],
  "Podomoro-Mantos": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL", "TRANSFER_TATELI", "TRANSFER_AIRMADIDI"],
  "Xpress-Paniki": ["TRANSFER_ITC", "TRANSFER_KLEAK", "TRANSFER_MALALAYANG", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL", "TRANSFER_TATELI", "TRANSFER_AIRMADIDI"],
  "Xpress-ITC": ["TRANSFER_PANIKI", "TRANSFER_KLEAK", "TRANSFER_MALALAYANG", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL", "TRANSFER_TATELI", "TRANSFER_AIRMADIDI"],
  "Xpress-Maumbi": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL", "TRANSFER_TATELI", "TRANSFER_AIRMADIDI"],
  "Xpress-Tuminting": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL", "TRANSFER_TATELI", "TRANSFER_AIRMADIDI"],
  "Xpress-17Agustus": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_PERKAMIL", "TRANSFER_TATELI", "TRANSFER_AIRMADIDI"],
  "Xpress-Perkamil": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_TATELI", "TRANSFER_AIRMADIDI"],
  "Xpress-Tateli": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL", "TRANSFER_AIRMADIDI"],
  "Xpress-Airmadidi": ["TRANSFER_ITC", "TRANSFER_PANIKI", "TRANSFER_MALALAYANG", "TRANSFER_KLEAK", "TRANSFER_MANTOS", "TRANSFER_MAUMBI", "TRANSFER_TUMINTING", "TRANSFER_17AGUSTUS", "TRANSFER_PERKAMIL", "TRANSFER_TATELI"],
...
export default function InventoryTransaction({
  ...
  const transactionTypeOptions = [
    ...
    ...(allowedTransferTypes.includes("TRANSFER_KDABATAMCENTRE")
      ...
      : []),
    ...(allowedTransferTypes.includes("TRANSFER_MITRARAYA")
      ? [{ value: "TRANSFER_MITRARAYA", label: "Transfer (MitraRaya)" }]
      : []),
    ...
    ...(allowedTransferTypes.includes("TRANSFER_ITC")
      ...
      : []),
    ...(allowedTransferTypes.includes("TRANSFER_MAUMBI")
      ? [{ value: "TRANSFER_MAUMBI", label: "Transfer (Maumbi)" }]
      : []),
    ...(allowedTransferTypes.includes("TRANSFER_TUMINTING")
      ? [{ value: "TRANSFER_TUMINTING", label: "Transfer (Tuminting)" }]
      : []),
    ...(allowedTransferTypes.includes("TRANSFER_17AGUSTUS")
      ? [{ value: "TRANSFER_17AGUSTUS", label: "Transfer (17 Agustus)" }]
      : []),
    ...(allowedTransferTypes.includes("TRANSFER_PERKAMIL")
      ? [{ value: "TRANSFER_PERKAMIL", label: "Transfer (Perkamil)" }]
      : []),
    ...(allowedTransferTypes.includes("TRANSFER_TATELI")
      ? [{ value: "TRANSFER_TATELI", label: "Transfer (Tateli)" }]
      : []),
    ...(allowedTransferTypes.includes("TRANSFER_AIRMADIDI")
      ? [{ value: "TRANSFER_AIRMADIDI", label: "Transfer (Airmadidi)" }]
      : []),
  ];
